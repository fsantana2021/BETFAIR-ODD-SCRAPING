...
def geral():
    ...
    link_home_futebol = 'https://www.betfair.com/exchange/plus/pt/futebol/equador-s%C3%A9rie-b/manta-fc-x-cd-america-de-quito-apostas-32524122'
    ...
    local2 = 'F:/arquivo/'+ str(data_hora_formatada) + '.xlsx'
    print(local2)
